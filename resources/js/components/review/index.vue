<template>
    <div class="index-page review-index form-box-container">
        <div class="row">
        ...
        <div class="sp-margin-15 mt-4">
                    ...
                    >
                        ...
                        <td>
                            <a  
                                ...
                                :href="`/admin/review/item/${review.id}`"
                                >{{ review.user }}</a
                            >
                        </td>
                        <td>
                        ...
                        <td class="text-center">{{ review.totalScore }}</td>
                        <td class="text-center">
                            {{ review.created_at }}
                        </td>
                        <td>
            ...
            <div class="position-relative" v-if="reviews != ''">
                <paginate
                    :page-count="lastPage"
    ...
    methods: {
        ...
        deleteAll() {
           console.log(this.selectedIds);
            axios.post(this.initData.urlDeleteAllData, {
                    id: this.selectedIds,
            })
            .then(() => {
                this.getData();
        ...
        getData(page) {
            ...
            axios
                ...
                .then(function (response) {
                    that.reviews = response.data.data;
